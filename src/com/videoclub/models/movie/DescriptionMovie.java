...
public class DescriptionMovie extends Common<DescriptionMovie> implements CommonInterface<DescriptionMovie>
{
	...
	public Integer create() throws SQLException
	{
		...
		String sql = "INSERT INTO " + DatabaseTableName.DESCRIPTION_MOVIES + " (" + "CODE," + "TITLE," + "DESCRIPTION," + "RELEASE_DATE," + "NEW," + "PRICE" + ") VALUES (" + "'" + code + "', " + "'" + title + "', " + "'" + description + "', " + "'" + releaseDate + "', " + "" + (newRelease ? 1 : 0) + ", " + price + "" + ");";
