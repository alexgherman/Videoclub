...
public class PickItemsWindow extends JDialog
{
	...
	private JScrollPane choicesPanel = new JScrollPane(itemChoicesPanel);	//Un JScrollPane garde toujours la m�me dimension. S'il y a trop de composants, il cr�e un scrollBar
