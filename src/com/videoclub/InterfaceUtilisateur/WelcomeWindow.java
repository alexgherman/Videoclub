 ...
 * La premi�re fen�tre ouverte par le programme
 * 
 * Donne le choix entre le mode Employ� ou G�rant
 * 
...
public class WelcomeWindow extends JFrame
{
	...
	private JButton employeeButton = new JButton("Employ�");
	private JButton managerButton = new JButton("G�rant");
	...
	{
		super(videoClub.getName());	//Titre de la fen�tre		
